...
template <int graph_size>
void LocationGraph<graph_size>::get_trackByIndex(int index,VertexRecord& vr, const List <const Node<PictureRecord >  *>*& trackListPtr) const
{
...
void LocationGraph<graph_size>::positionToNum(int x, int y,int& index, int& no) const{
 ...
 int LocationGraph<graph_size>::get_verterxCount() const{//即count
  ...
  template <int graph_size>
 string LocationGraph<graph_size>::the_name() const{//即
